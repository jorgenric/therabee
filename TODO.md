...
- [x] §5.1 Home screen — time-of-day greeting in TopAppBar, "N of M done today" summary line, "Start: [Exercise Name]" full-width button for the next pending exercise
